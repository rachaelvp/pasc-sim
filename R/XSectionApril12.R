...
simp.res <- rbind(simp.res,c(simple.df$aver,simple.df.hal$aver,simple.df.hal_cv$aver,simple.df.SL$aver,simple.df$reg[,1],simple.df$reg[,2],simple.df.hal$reg[,1],simple.df.hal$reg[,2],simple.df.hal_cv$reg[,1],simple.df.hal_cv$reg[,2],simple.df.SL$reg[,1],simple.df.SL$reg[,2]))

tmle.res <- rbind(tmle.res,c(tmle_fit_org$summary$tmle_est,tmle_fit_org$summary$se,tmle_fit_hal$summary$tmle_est,tmle_fit_hal$summary$se,tmle_fit_hal_cv$summary$tmle_est,tmle_fit_hal_cv$summary$se,tmle_fit_SL$summary$tmle_est,tmle_fit_SL$summary$se))

}
save.image("April12.rdata")
